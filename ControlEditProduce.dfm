object FrControlEditProduce: TFrControlEditProduce
  Left = 0
  Top = 0
  Caption = #1050#1086#1085#1090#1088#1086#1083#1100' '#1101#1082#1089#1087#1086#1088#1090#1072' '#1087#1088#1086#1076#1091#1082#1090#1086#1074#1086#1075#1086' '#1082#1072#1090#1072#1083#1086#1075#1072
  ClientHeight = 558
  ClientWidth = 1056
  Color = clBtnFace
  ...
  object RzPanel2: TRzPanel
    ...
    object RzGroupBox1: TRzGroupBox
      ...
      Height = 42
      Align = alBottom
      Caption = #1042#1074#1077#1076#1080#1090#1077' '#1080#1089#1082#1086#1084#1091#1099#1081' '#1087#1088#1086#1076#1091#1082#1090' '
      Color = 15329769
      GroupStyle = gsCustom
      TabOrder = 0
      Transparent = True
    ...
    object RzSplitter1: TRzSplitter
      ...
      object RzPanel5: TRzPanel
        ...
        object RzRadioButton2: TRzRadioButton
          ...
          Width = 136
          Height = 15
          Caption = #1042#1089#1077' '#1085#1086#1074#1099#1077'\'#1080#1079#1084#1077#1085#1077#1085#1085#1099#1077
          Checked = True
          TabOrder = 2
          TabStop = True
          OnClick = RzBitBtn8Click
        ...
        object RzRadioButton1: TRzRadioButton
          ...
          Width = 143
          Height = 15
          Caption = #1042#1089#1077' '#1085#1086#1074#1099#1077'\'#1086#1073#1085#1086#1074#1083#1077#1085#1085#1099#1077
          TabOrder = 3
          OnClick = RzBitBtn8Click
        end
      end
  ...
  object ImageList1: TImageList
    ...
    Top = 53
    Bitmap = {
      494C010120003800280010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object ImageList2: TImageList
    ...
    Top = 128
    Bitmap = {
      494C010154007000280010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object QControl: TADOQuery
    ...
    Prepared = True
    SQL.Strings = (
      '/*SELECT B.iText, C.iText,A.* FROM all_AdvProduceClass A'
      '  LEFT JOIN spl_LbText512 B ON B.Idn=A.id512Name '
      '  LEFT JOIN spl_LbText24 C ON C.Idn=A.Id24TypeName'
      
        'WHERE isnull(A.IdnDO_PI,0)<>0 AND A.iType=4 AND isnull(A.IdnDO_P' +
        'I,0) NOT  in (SELECT isnull(IdnDO,0) FROM dbo.all_AdvPriseListEt' +
        'alon)'
      '*/'
      ''
      ''
      'UPDATE all_AdvProduceClass SET NotComparing=1;'
      ''
      '---'
      ''
      'UPDATE A '
      ...
      'LEFT JOIN all_AdvProduceClassTmp B ON A.Idn=B.Idn'
      'WHERE A.Idn=B.Idn'
      'AND isnull(A.idnP,0)=isnull(B.idnP,0)'
      'AND isnull(A.Id512NameCatalog,0)=isnull(B.Id512NameCatalog,0)'
      'AND isnull(A.id512Name,0)=isnull(B.id512Name,0) '
      'AND isnull(A.IdAdvCond,0)=isnull(B.IdAdvCond,0)'
      'AND isnull(A.IdAdvPriseList,0)=isnull(B.IdAdvPriseList,0)'
      'AND isnull(A.Id24TypeName,0)=isnull(B.Id24TypeName,0)'
      'AND isnull(A.CodeB,0)=isnull(B.CodeB,0) '
      'AND isnull(A.iType,0)=isnull(B.iType,0)'
      'AND isnull(A.GrantBits,0)=isnull(B.GrantBits,0)'
      ...
      'AND isnull(A.ISSN,0)=isnull(B.ISSN,0)'
      'AND isnull(A.srcActual,0)=isnull(B.srcActual,0)'
      '--AND isnull(A.DateLastExport,0)=isnull(B.DateLastExport,0)'
      'AND isnull(A.IdnDO_PI,0)=isnull(B.IdnDO_PI,0)'
      ''
      '--'#1044#1083#1103' '#1074#1089#1077#1075#1086
      
        'UPDATE all_AdvProduceClass SET NotComparing=2 Where NotComparing' +
        '=0;'
      ''
      'UPDATE A '
      'Set A.NotComparing=0'
      ...
      ' IF (@viTmp=:D0)'
      '  BEGIN'
      #9'SELECT B.iText, C.iText,A.* FROM all_AdvProduceClass A'
      #9'LEFT JOIN spl_LbText512 B ON B.Idn=A.id512Name '
      
        #9'LEFT JOIN spl_LbText24 C ON C.Idn=A.Id24TypeName WHERE A.NotCom' +
        'paring=1  ORDER BY B.iText'
      '  END'
      ' ELSE'
      '  BEGIN'
      #9'SELECT B.iText, C.iText,A.* FROM all_AdvProduceClass A'
      #9'LEFT JOIN spl_LbText512 B ON B.Idn=A.id512Name '
        ...
        #9'LEFT JOIN spl_LbText24 C ON C.Idn=A.Id24TypeName  WHERE A.NotCo' +
        'mparing IN (1,2)  ORDER BY B.iText'
      '  END')
    Left = 256
    Top = 440
    object QControlidn: TIntegerField
      FieldName = 'idn'
      ReadOnly = True
    end
    object QControlidnP: TIntegerField
      FieldName = 'idnP'
    end
    object QControlId512NameCatalog: TIntegerField
      FieldName = 'Id512NameCatalog'
    end
    object QControlid512Name: TIntegerField
      FieldName = 'id512Name'
    end
    object QControlIdAdvCond: TIntegerField
      FieldName = 'IdAdvCond'
    end
    object QControlIdAdvPriseList: TIntegerField
      FieldName = 'IdAdvPriseList'
    end
    object QControlId24TypeName: TIntegerField
      FieldName = 'Id24TypeName'
    end
    object QControlCodeB: TStringField
      FieldName = 'CodeB'
      Size = 16
    end
    object QControliType: TIntegerField
      FieldName = 'iType'
    end
    object QControlGrantBits: TIntegerField
      FieldName = 'GrantBits'
    end
    object QControlDateIns: TDateTimeField
      FieldName = 'DateIns'
    end
    object QControlIdIns: TIntegerField
      FieldName = 'IdIns'
    end
    object QControlDateMod: TDateTimeField
      FieldName = 'DateMod'
    end
    object QControlIdMod: TIntegerField
      FieldName = 'IdMod'
    end
    object QControlDateDel: TDateTimeField
      FieldName = 'DateDel'
    end
    object QControlIdDel: TIntegerField
      FieldName = 'IdDel'
    end
    object QControlidnOld: TIntegerField
      FieldName = 'idnOld'
    end
    object QControlISSN: TWideStringField
      FieldName = 'ISSN'
      Size = 24
    end
    object QControlsrcActual: TIntegerField
      FieldName = 'srcActual'
    end
    object QControlDateLastExport: TDateTimeField
      FieldName = 'DateLastExport'
    end
    object QControlIdnOldImport: TIntegerField
      FieldName = 'IdnOldImport'
    end
    object QControlIdnDO_PI: TIntegerField
      FieldName = 'IdnDO_PI'
    end
    object QControliText: TStringField
      FieldName = 'iText'
      Size = 512
    end
    object QControliText_1: TStringField
      FieldName = 'iText_1'
      Size = 24
    end
  end
  object QProduce: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  SET @MyStr='#39#39';'
        ...
        '  set @MyStr='#39' /* (A.srcActual=1) AND  A.Id512NameCatalog=944122' +
        '5 9113095 and*/ (A.iType=4 or A.iType=3 or A.iType=2) and A.date' +
        'del is null AND B.iText LIKE '#39#39'%'#39'+@MyStr+'#39'%'#39#39#39';'
      ''
      '  insert into #WsTempTreeId(Idn) '
        ...
        '  select DISTINCT A.idn, A.idnP,B.iText, A.iType,C.iText TypeNam' +
        'e,A.IdIns, D.auFamIO, isnull(A.ISSN,'#39#39') ISSN, isnull(A.CodeB,'#39#39')' +
        ' CodeB, isnull(E.fActual,0) fActual , isnull(A.Id24TypeName,0) I' +
        'd24TypeName '
      '  from all_AdvProduceClass A '
      '  LEFT JOIN spl_LbText512 B ON B.Idn=A.id512Name '
      '  LEFT JOIN spl_LbText24 C ON C.Idn=A.Id24TypeName '
      ...
      '  LEFT JOIN  vwActualProduce E ON E.Idn=A.Idn '
        ...
        '  where /*A.iType<>4 AND*/ A.DateDel is null and A.idn in(select' +
        ' idn from #WsTempTreeId) AND (((E.fActual=1)AND A.iType=3) OR A.' +
        'iType IN (1,2,4) )'
