...
#ifndef PrintProductCatalogH
#define PrintProductCatalogH
#include "Init.h"
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
int IdUser;
void __fastcall LoadPicList(TStrings *NameUser,TStrings *Status ,TStrings *Activities_KC,TStrings *ComboBox9);
