...
//---------------------------------------------------------------------------
class TFrFundRTFText : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBBandedColumn *cxGridTableViewEmplUserContentTargetRTF;
...
public:		// User declarations
	__fastcall TFrFundRTFText(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFrFundRTFText *FrFundRTFText;
//---------------------------------------------------------------------------
#endif
